...
// Update attendance data if form is submitted
...
<head>
    ...
    <title>Rekap Absensi - Kelas 10 RPL</title>
    <style>
        body {
...
<body>
    ...
    <header>
        <h1>Rekap Absensi Kelas 10 RPL</h1>
    </header>

    <nav>
        <a href="test_absensi.html">Beranda</a>
        <a href="students.html">Absensi Siswa</a>
        <a href="recap_absen.php">Rekap Absensi</a>
    </nav>
            ...
            <form method="POST" action="">
                <table>
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($_SESSION['attendance Data'] as $name => $present) {
                            echo "<tr>
                                    <td>{$no}</td>
                                    <td>{$name}</td>
                                    <td>
